let starIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#FACC2E" class="bi bi-star-fill" viewBox="0 0 16 16">
        ...
        for (let i = 0; i < rankCardItems.length; i++) {
            ...
            if (rankCount <= 3) {
                const top3TempHtml = `<div class="col-md-4">
                                    <div class="card">
                                        <a onclick="IdolRankModalInfo('${youtubeScore}','${spotifyScore}','${instaScore}','${googleScore}','${idolName}','${idolImage}','${rankCount}')" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">
